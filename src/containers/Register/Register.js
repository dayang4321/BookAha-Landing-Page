...
const Register = (props) => {
        ...
        <Col md={6} className="pr-md-4 px-3 px-md mb-3 mb-md">
          <Input
            inputAttr={{
              ...
              name: 'name',
              onChange: (e) =>
                inputChangeHandler(e, 'name', registerForm, setRegisterForm),
              required: true,
        ...
        <Col md={6} className="pl-md-4 px-3 px-md">
          <Input
            inputAttr={{
              ...
              name: 'email',
              onChange: (e) =>
                inputChangeHandler(e, 'email', registerForm, setRegisterForm),
              required: true,
        ...
        >
          <Input
            inputAttr={{
              ...
              required: false,
              value: registerForm.isSubscribed.value,
            }}
            id="isSubscribed"
            label={t('register.input.isSubscribed.label')}
          />
        </Col>
    ...
    case 'footer':
      formHeader = (
        <h1 className="footer-title mb-5">
          {isSignedUp
            ? t('register.title.footer.success')
            : t('register.title.footer.default')}
        </h1>
      );
      break;
    case 'modal':
  ...
  return formLoading ? (
    ...
    <>
      {hasError ? (
        <h1 className="text-white mb-4">{t('register.title.error')}</h1>
      ) : (
        formHeader
      )}
      {formBody}
